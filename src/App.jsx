...
function App() {
  const websiteLaunchDate = new Date("2025-11-30T13:00:00+03:00").getTime();
      ...
      <div className="placeholder-container">
        ...
        <div className="shadow">
          <div className="container">
            ...
            <h2 className="logo-signature">
              Приватний нотаріус, медіатор, перекладач
            </h2>
            <h1 className="title">
              Інфо-платформа про право, рішення та зміни.
            </h1>
            ...
            <div className="social-block">
              <div className="social-block-wrap">
                <a
                  ...
                  href="https://www.tiktok.com/@korneenkova_nadia"
                >
                  <img
                    src={ticktock}
                    className="social-block-img"
                    alt="TikTok"
                  />
                </a>
              </div>
              <div className="social-block-wrap">
                <a
                  className="social-block-link"
                  href="https://www.facebook.com/nk.prnotary"
                >
                  <img
                    src={facebook}
                    className="social-block-img"
              ...
              <div className="social-block-wrap">
                <a
                  className="social-block-link"
                  href="https://www.instagram.com/nadia_korneenkova_notary/"
                >
                  <img
                    src={instagram}
                    className="social-block-img"
